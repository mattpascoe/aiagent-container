...
│   ├── entrypoint.sh           # Restores ~/.claude.json, merges MCP entry, starts coms listener, execs claude
...
└── docs/
    ...
    ├── comms-inner-followups.md
    │                            # Follow-up items for the agentharness-comms system
